...
use crate::declaration::{DeclarationInput, DeclarationMetadata};
...
const fn message(operation: Operation, name: &'static str, input: Input) -> Fixture {
    Fixture {
        operation,
        name,
        input,
...
pub(super) const FIXTURES: [Fixture; 12] = [
    message(Operation::LiteralEncode, "plain", Input::Literal("Pay now")),
    message(
