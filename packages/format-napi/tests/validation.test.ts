...
test('invalid source type returns invalid_options before native loading', () => {
...
test('invalid snapshot type returns invalid_options before native loading', () => {
...
test('invalid snapshot check input returns invalid_options before native loading', () => {
