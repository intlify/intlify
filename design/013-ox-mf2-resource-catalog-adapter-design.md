...
| [014-ox-mf2-message-linker-design.md](./014-ox-mf2-message-linker-design.md) | application-reference artifacts; CLI-owned physical-source grouping, pre-extraction group admission, and one checked post-extraction linker-definition projection per physical-source group, without a resource-to-contract dependency or resource-owned file aggregation; selector/domain contracts and linker-owned matching; language-neutral linking, reachability, locale/fallback resolution, and bundle-plan generation; the future M5 consumer of a separate resource-owned structural-deletion boundary |
