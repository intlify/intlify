...
The language-neutral application-reference artifacts, reachability analysis, locale/fallback resolution, and bundle-plan architecture that can supply usage evidence are owned by [014-ox-mf2-message-linker-design.md](./014-ox-mf2-message-linker-design.md). The linker consumes this document's extraction, catalog-key, locale-binding, and comparison-scope contracts; it does not introduce another catalog parser or accept deferred resource configuration fields early. Linker findings become `intlify lint` rules only through the dedicated linter addendum required by this section and the Phase 3C linter contract.
...
| [014-ox-mf2-message-linker-design.md](./014-ox-mf2-message-linker-design.md) | application-reference artifacts, language-neutral linking, reachability, locale/fallback resolution above resource metadata, and bundle-plan generation |
