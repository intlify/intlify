...
| [029](./029-intlify-product-workflow-and-packaging-design.md) | Host obligations for explicit operations, exact-base atomic registry publication, and the local Store lineage and Release destination adapters | Exercise those obligations through a local test host without fixing public commands or packaging |
