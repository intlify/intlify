...
The parallel message-linker and distribution track extends this plan without duplicating its complete benchmark registry here. [014-ox-mf2-message-linker-design.md](./014-ox-mf2-message-linker-design.md#benchmarks) owns the canonical reference-producer, artifact-codec, definition-projection, linker, export-preparation, exporter, output-registration, and messages-command phase and cost vocabulary. Its fresh-process end-to-end records always retain the unadjusted measurement.
