...
| `invalid-declaration-dependency` | core semantic | declaration self-reference and forward-binding cases of the Duplicate Declaration family, including input declaration function options and local declaration expressions |
