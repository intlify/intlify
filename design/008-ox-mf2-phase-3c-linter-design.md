...
- Concrete catalog-level, cross-locale, and linker-backed usage-aware linter rules beyond the message-level core, including the later L0/L1 presentation adapters under the integration boundary in [013-ox-mf2-resource-catalog-adapter-design.md](./013-ox-mf2-resource-catalog-adapter-design.md#catalog-level-checks) and the architecture in [014-ox-mf2-message-linker-design.md](./014-ox-mf2-message-linker-design.md). This deferred lint work does not gate linker M0.
