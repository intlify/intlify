...
7. file loader, optional Programmatic Entry Snapshot frontend, vocabulary- and canonicalization-data product integration, host Delivery Unit Graph handoff, exact Resolver Construction Root Package and complete Resolver Construction Input Set retention for replay, and downstream-consumer evidence.
